...
```{r pairplots, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = figRef('pairplots', 'Distributions of, and correlations between alpha, beta, and gamma diversities within units'), fig.height = 8, fig.width = 8}
psych::pairs.panels(units_merged_beta_subset@data[c(
  'tax_alpha_div', 'tax_beta_div', 'tax_gamma_div', 
  'func_alpha_div', 'func_beta_div', 'func_gamma_div', 
