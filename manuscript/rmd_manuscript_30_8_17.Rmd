...
We calculated $\beta_{\text{eqv}}$ as the total diversity of a unit ($\gamma_{\text{eqv}}$) minus the average diversity of mnbba points ($\alpha_{\text{eqv}}$) within a unit, and calculated $\beta_{\text{prop}}$ as the proportion of $\gamma_{\text{eqv}}$ explained by $\beta_{\text{eqv}}$. By taking the number of forested bird count points into account, we were able to compare the proportion of $\gamma_{\text{eqv}}$ explained by $\beta_{\text{eqv}}$ between units with differing numbers of points. In addition, using a proportional measure of $\beta_{\text{eqv}}$ enabled us to directly compare the proportion explained by different facets of biodiversity (taxonomic, functional, and phylogenetic).
