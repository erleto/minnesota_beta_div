...
expl_names_1 <- c('Intercept', 'Human footprint', 'Roadlessness', 'Forest loss', 'Net primary production', 'Habitat diversity', 'Mean temperature')
expl_names_2 <- c('Intercept', 'Human footprint', 'Roadlessness', 'Forest loss', 'Net primary production', 'Habitat diversity', 'Mean temperature', 'Number forested points')
```
<br>
...
rownames(tax_beta_model_coef) <- expl_names_2
...
rownames(func_beta_model_coef) <- expl_names_2
...
rownames(phyl_beta_model_coef) <- expl_names_2
...
rownames(tax_alpha_model_coef) <- expl_names_1
...
rownames(tax_gamma_model_coef) <- expl_names_2
...
rownames(func_alpha_model_coef) <- expl_names_1
...
rownames(func_gamma_model_coef) <- expl_names_2
...
rownames(phyl_alpha_model_coef) <- expl_names_1
...
rownames(phyl_gamma_model_coef) <- expl_names_2
