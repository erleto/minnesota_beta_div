...
that contribute to land use change such as agriculture, timber harvesting, and urbanisation have
...
[@FAOGlobalforestresources2016]. There
...
[@FAOGlobalforestresources2016]. In addition, an increasing threat to forests worldwide is
...
Human activities appear to impact different scales of
biodiversity in different ways [@McGillFifteenformsbiodiversity2015]. Studies have shown that
...
diversity is not necessarily the only goal [@SocolarHowShouldBetaDiversity2016]. For
...
causing the introduction of exotic and invasive species and extinctions of native species have the potential to cause species
composition in different sites to become more similar
[@BaiserPatternprocessbiotic2012]. Local species extinctions often involve 
specialists with narrow dietary and habitat preferences, and they are often
replaced by generalists that can withstand fluctuating environmental conditions and human-built environments
...
[@OliverBiodiversityResilienceEcosystem2015]. In addition, specialised species often 
...
We studied how land-use change due to human actions causes biotic
homogenisation in bird communities of forested habitats in the state of
Minnesota, USA. Our aim was to study if an increasing human footprint, which
includes human population, transport infrastructure, and forest change, causes
...
predicted that increased human footprint and forest change would lead to decreased
...
township, three point locations were selected. The first point was placed in a random land use class, 
the second point represented the most common land use class in the township, and the last point was 
placed in the second most common land use class in the township. Land use data were derived from the 2001 National Land Cover
...
In addition to studying the impact of general human influence we also wanted to study how changes in forest cover influence biodiversity. We quantified forest change from the global forest change dataset developed by @HansenHighResolutionGlobalMaps2013 [-@HansenHighResolutionGlobalMaps2013]. The
...
cover of forest change between 2000 and 2014. However, there was no reliable way of
systematically separating forest change caused by humans from change caused by
natural events such as forest fires and storms. 
There were four units that had been significantly impacted by
three large forest fires (Pagami Creek (2011), Cavity Lake (2006) and Ham Lake
(2007) fires). Since the results from models run with and without the affected units did not change significantly, we decided to keep these units in the analyses. Habitat diversity for each unit was quantified by calculating
...
# Discussion  
Elevated human pressure did not appear to be related with increased biotic homogenisation in our
study site. An Increase in the human footprint index (HFI), which measured the impact of
...
between sites. Forest change did not appear to cause biotic homogenisation in any
...
between sites. Although we considered the diversity of land classes within each unit, 
it is possible that increased human impact diversified habitats at
finer scales. Another potential reason that beta diversity increases in response to
...
region, which have experienced heavy logging of natural forests over the past 100-150
years [@SchulteHomogenizationnorthernGreat2007], have already been homogenised in
terms of species composition and forest structure to such an extent that current forest
management activities occuring have limited impact on the composition of bird communities.
Indeed, forests in the area still bear a clear signature of previous land use
change [@SchulteHomogenizationnorthernGreat2007]. On the other hand, forest change
did have a clear impact on local and regional diversity. A loss in the cover of mature forest
...
diversity was not statistically significant. Since forest change had a negative impact at both local
and regional scales, the method of calculating between-site diversity canceled
out the impact of forest change on between-site diversity, meaning that no
homogenising impact could be seen. This suggests that even though units lost
local and regional diversity in response to forest change, MNBBA sites did not
become more alike.  
