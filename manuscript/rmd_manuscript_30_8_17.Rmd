...
```{r pairplots, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = figRef('pairplots', 'Distributions and correlations between forest species richness, taxonomic, functional, and phylogenetic beta diversity within units')}
