...
```{r div_plots, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = figRef('div_plots', 'Correlations between forest species richness, taxonomic, functional, and phylogenetic beta diversity, and their distributions')}
...
#Appdendix  
##1. Correlations between human footprint and human influence components in Minnesota data
  
##2. Correlations between explanatory variables and their distributions
```{r explanatory_plots, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = figRef('explanatory_plots', 'Correlations between explanatory variables, and their distributions')}
psych::pairs.panels(units_merged_beta_subset@data[c('human_footprint', 
  'forest_loss', 'habitat_div', 'net_prim_prod', 'mean_temp', 'forest_point_freq')], hist.col = NULL)
```
...
```{r tax_vif, echo = FALSE, message = FALSE, warning = FALSE, results = 'asis'}
pander::pander(tax_model_vif)
```
  
###b) Functional beta diversity  
```{r func_vif, echo = FALSE, message = FALSE, warning = FALSE, results = 'asis'}
pander::pander(func_model_vif)
```
  
###c) Phylogenetic beta diversity  
```{r phyl_vif, echo = FALSE, message = FALSE, warning = FALSE, results = 'asis'}
