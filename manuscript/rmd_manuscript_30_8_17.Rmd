...
#Introduction  
Global studies have shown that land-use changes and their associated pressures have significantly decreased local species richness and abundance (Newbold et al. 2015), and have led to strong, consistent and accumulating negative impacts on biodiversity (Haddad et al. 2015). However, there appear to be differing effects of human activities on different scales of biodiversity. Studies have shown that biodiversity at the local scale (alpha diversity) has not changed significantly through time, whereas biodiversity at regional scales (gamma diversity) and the global scale has decreased.

Recently, the concept of biotic homogenisation, the process by which communities become increasingly similar, has increasingly gained attention. Biotic homogenisation is a pressing worldwide problem. Human activities causing species invasions and extinctions have the potential to cause species composition in different sites to become more similar. The precise mechanisms causing biotic homogenisation are still unclear.

In practice, biotic homogenisation can be measured by comparing the mean beta diversities of regions. Beta diversity measures variation in biodiversity in space and is derived from the total diversity of a region and the local diversities of sampled sites since it cannot be measured directly (ref). Beta diversity, in its original proposed form, is calculated as gamma diversity divided by the mean alpha diversity of a region. In this form, beta diversity is a unitless measure that reflects how many local sites there would be if none of the sites shared common species. A higher level of beta diversity in a region indicates that the composition of local sites are different from each other than in a region with a lower level of beta diversity.  However, in a conservation setting, maximising beta diversity is not necessarily the goal. Uneven losses in species between sites can lead to decreased mean alpha diversity, which will increase the beta diversity of a region. On the other hand, the colonisation of specialists into new sites can increase mean alpha diversity, leading to a decrease in the beta diversity of a region.

Biotic homogensiation, and many other phenomena related to biodiversity, has been studied mainly from the aspect of the number of species, also known as taxonomic diversity. However, only studying the taxonomic diversity of a region gives a limited understanding of biodiversity in a region. Phylogenetic diversity, which captures the evolutionary history of communities, and functional diversity, which reflects the ecological functions performed by species have received less attention even though they offer important insights. Of these, functional diversity is of special concern for human well-being as it is an important component of ecosystem functioning, which is the basis of the ecosystem services that humans depend on (Cardinale et al. 2012). There is already evidence that the loss of biodiversity is creating an ecosystem services debt that will be exacerbated by continuing biodiversity loss (Isbell et al. 2015), with potential decrease in the resilience of ecosystem functions (Oliver et al. 2015). Although we have an understanding of the impacts of biotic homogenisation on taxonomic diversity, functional and phylogenetic homogenisation have received much less attention. 

In this study, we studied how land-use change caused by human actions causes biotic homogenisation in the state of Minnesota, USA. Our aim was to study if increasing human footprint, which includes human population, transport infrastructure, and forest loss, causes sites to become more similar to each other (decreased beta diversity). 
* What we did 
