...
was a fairly strong biological impact (`r func_beta_hfp_perc`%). Forest change 
did not appear to influence functional beta diversity. Interestingly, net primary 
(NPP) had a strong negative impact on functional beta diversity. Along the range 
of NPP values, functional beta diversity decreased by `r abs(func_beta_npp_change)` 
units (`r func_beta_npp_perc`%), which was even stronger than the impact of HFI. 
Similarly, mean annual temperature had a negative impact, decreasing functional 
beta diversity by `r abs(func_beta_temp_change)` units (`r func_beta_temp_perc`%).  
...
impacted by HFI, nor forest change. Phylogenetic beta diversity was negatively
associated with NPP and mean temperature, although the biological impacts were 
much stronger. Along the range of NPP values (`r tabRef("explanatory_summary")`)
