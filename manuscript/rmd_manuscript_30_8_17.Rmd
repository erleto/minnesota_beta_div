...
Within each unit we calculated taxonomic, functional, and phylogenetic `r '\u03b2'` diversities with Rao’s quadratic entropy using R functions developed by De Bello et al. \u03b2 diversity partitioned additively as the total diversity of a unit (`r '\u03b3', $\gamma$) minus the average diversity within BBA points (\u03b1). 
The taxonomic \u03b2 diversity of a unit represents 
