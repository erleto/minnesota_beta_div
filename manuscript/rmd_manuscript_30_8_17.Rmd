...
Forest loss was quantified from the the global forest change dataset developed by Hansen et al. (2013). The dataset uses Landsat data to quantify gross forest loss and gain at an annual frequency between 2000 and 2014. For each unit we calculated the percent cover of forest loss between 2000 and 2014. There was no reliable way of systematically separating forest loss caused by humans from loss caused by natural events such as forest fires and storms. To limit this potential source of disturbance, we left out four units that had been significantly impacted by two large forest fires (Pagami Creek and Ham Lake fires).
