...
[@SchulteHomogenizationnorthernGreat2007]. On the other hand, forest change did
have a clear impact on local and regional diversity. A loss in the cover of
mature forest coverage did, however, appear to decrease functional and
phylogenetic diversity at the local and regional scales, although the impact on
regional functional diversity was not statistically significant. Since forest
change had a negative impact at both local and regional scales, the method of
calculating between-site diversity would have canceled out the impact of forest
change on between-site diversity, meaning that no homogenising impact could be
seen. This suggests that even though units lost local and regional diversity in
response to forest change, MNBBA sites did not become more alike.  

Forestry might have been expected to increase differences between sites since
the amount of forest under forest management has been steadily decreasing since
at least 1990 [@NiemiAnalysislongtermforest]. Indeed, early successional species
such as the Chestnut-sided Warbler, Mourning Warbler, and Veery have shown clear
declines, possible due to the lack of young successional forest stands and high
abundance cover of middle-aged forests in the state
([MNBBA](https://mnbirdatlas.org/).
...
differences in diversity between sites, might be desireable. This could be
achieved by increasing total diversity, but if an increase in between-site
diversity comes at the expense of a decrease in diversity at a local scale, then
the desireability of such an outcome must be considered critically
[@SocolarHowShouldBetaDiversity2016]. Our study also highlights the importance
of taking multiple facets of biodiversity into account. The positive influence
of increase human footprint on biodiversity in our study region would have been
missed if we had only focussed on taxonomic diversity, as has often previously
been the case. Similarly, impacts on between-site and regional diversity would 
have been missed if we had only studied local diversity.
...
set.caption(tabRefApp('tax_alpha_model_summary', 'Summary of spatial error model explaining taxonomic alpha diversity'))
...
set.caption(tabRefApp('tax_gamma_model_summary', 'Summary of spatial error model explaining taxonomic gamma diversity'))
...
set.caption(tabRefApp('func_alpha_model_summary', 'Summary of spatial error model explaining functional alpha diversity'))
...
set.caption(tabRefApp('func_gamma_model_summary', 'Summary of spatial error model explaining functional gamma diversity'))
...
set.caption(tabRefApp('phyl_alpha_model_summary', 'Summary of spatial error model explaining phylogenetic alpha diversity'))
...
set.caption(tabRefApp('phyl_gamma_model_summary', 'Summary of spatial error model explaining phylogenetic gamma diversity'))
