...
```{r pairplots, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = figRef('pairplots', 'Correlations between forest species richness, taxonomic, functional, and phylogenetic beta diversity, and their distributions')}
...
##1. Correlations between diversity measures
...
##3. Histogram of number of forest BBA points per unit
```{r, echo = FALSE, message = FALSE, warning = FALSE}
...
##4. Spatial distribution of explanatory variables  
...
##5. List of used R packages and their versions  
