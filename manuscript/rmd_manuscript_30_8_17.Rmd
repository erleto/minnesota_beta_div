...
impacts on biodiversity [@haddad_habitat_2015]. Human pressures such as land
...
diversity is not necessarily the goal (Socolar et al. 2016). For example, uneven
...
(McCune & Vellend 2013), leading to a decrease in the beta diversity of a
region.  
...
Minnesota Breeding Bird Atlas ([MNBBA](https://mnbirdatlas.org/); Pfannmuller et
al. 2017).  The goal of the MNBBA was to systematically sample breeding birds
across the state by collecting data in each township of the state.  Townships
measure approximately 93 km2 (6 x 6 miles) and were developed by the Public Land
...
Database (Homer et al. 2004).  Counts were conducted primarily on secondary
...
‘isectpolyrst’ tool in Geospatial Modelling Environment version 0.7.3.0 (Beyer
2012). Landcover classes were derived from the LANDFIRE dataset (Rollins et al.
2006). One hundred and fifteen cover types in the LANDFIRE Existing Vegetation
...
by De Bello et al. (2010) The Rao index measures dissimilarity by summing total
