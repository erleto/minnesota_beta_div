...
Beta diversity was calcualted as total species diversity per unit divided by the mean alpha diversity per unit. This unitless measure reflects the number of individual BBA points with no overlapping species needed to achieve the before- mentioned aplha and gamma diversities.
...
set.caption(tabRef('phyl_model_summary', 'Summary of spatial error model explaining phylogenetic beta diversity'))
