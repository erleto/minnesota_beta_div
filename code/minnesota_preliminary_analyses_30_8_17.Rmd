...
units_merged_human_impact <- dplyr::select(units_merged, unit, human_footprint, 
  'forest_loss' = allV1, 'total_pop' = censusSUM, 'all_roads' = Dens_All, 
...
for (unit in as.vector(common_units$unit)) {
  ...
  tax_beta_unit_list[[counter]] <- bird_div$TD$Gamma / bird_div$TD$Mean_Alpha
  func_beta_unit_list[[counter]] <- bird_div$FD$Gamma / bird_div$FD$Mean_Alpha
  phyl_beta_unit_list[[counter]] <- bird_div$PD$Gamma / bird_div$PD$Mean_Alpha
