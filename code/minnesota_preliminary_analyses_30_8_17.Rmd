...
```{r, fig.show = 'hold', results = 'asis', fig.width = 10, fig.height = 10}
...
psych::pairs.panels(units_merged_human_impact_subset, hist.col = NULL)
```


```{r, fig.show = 'hold', results = 'hold', fig.width = 10, fig.height = 10}
# Pair plots of explanatory variables
psych::pairs.panels(as.data.frame(dplyr::select(explanatory_variables, -unit, -eco_subsection)), hist.col = NULL)
```
