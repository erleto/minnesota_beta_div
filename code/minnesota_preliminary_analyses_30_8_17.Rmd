...
error model.
```{r}
tax_model_spatial <- spdep::errorsarlm(f_tax_model, data = tax_model_variables, listw = units_merged_subset_lw, 
...
moments::skewness(residuals(func_model))
...
AIC(phyl_model)
moments::skewness(residuals(phyl_model))
