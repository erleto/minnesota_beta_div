...
* [Load miscellaneous data](#load_misc_data)  
[Calculate BBA points per unit](#calcualte_points_per_unit)  
[Standardise column names](#standardise_col_names)  
...
units_merged <- merge(units, units_forest_loss, by = 'unit')
...
####Phylogenetic beta diversity
```{r, eval = FALSE, results = 'hold', fig.show = 'hold', message = FALSE, warning = FALSE, fig.width = 8, fig.height = 4}
# Calculate global Moran's I with permutation test (function)
...
multiplot(plot_variable_map(units_merged_fort, 'human_footprint'), 
  plot_variable_map(units_merged_fort, 'allV1'), 
  plot_variable_map(units_merged_fort, 'Dens_Other'), 
  plot_variable_map(units_merged_fort, 'forest_point_freq'), 
  plot_variable_map(units_merged_fort, 'precMN'), 
  plot_variable_map(units_merged_fort, 'tempMN'), 
  plot_variable_map(units_merged_fort, 'npp'), 
  plot_lisa_map(units_merged, human_footprint, 1), 
  plot_lisa_map(units_merged, allV1, 1), 
  plot_lisa_map(units_merged, Dens_Other, 1), 
  plot_lisa_map(units_merged, forest_point_freq, 1), 
  plot_lisa_map(units_merged, precMN, 1), 
  plot_lisa_map(units_merged, tempMN, 1), 
  plot_lisa_map(units_merged, npp, 1), 
  cols = 2)
```
...
m <- lm(tax_beta_div ~ human_footprint + forest_loss + other_roads + mean_temperature + 
    mean_precipitation + forest_point_freq + npp, data = model_variables) #other_roads + 
summary(m)
