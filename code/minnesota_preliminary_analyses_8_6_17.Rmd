...
phyl_model = spdep::lagsarlm(f_phyl_model, data = phyl_model_variables, listw = units_merged_subset_lw, tol.solve = 1.0e-30, zero.policy = TRUE)
phyl_model = spdep::errorsarlm(f_phyl_model, data = phyl_model_variables, listw = units_merged_subset_lw, tol.solve = 1.0e-30, zero.policy = TRUE)
...
saveRDS(phyl_model_summary, file = './results/phyl_model_summary.rds')
#save(phyl_model_vif, file = './results/phyl_model_vif.rdata')
phyl_model_summary
#phyl_model_vif
```
