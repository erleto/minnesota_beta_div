...
tax_mean_alpha_unit_list <- vector("list", base::nrow(common_units))
...
for (unit in as.vector(common_units$unit)) {
  ...
  tax_mean_alpha_unit_list[[counter]] <- bird_div$TD$Mean_Alpha
  tax_gamma_unit_list[[counter]] <- bird_div$TD$Gamma
  #########
}
...
bird_div_all <- Rao(sample = bird_points_species_wide, dfunc = trait_distance, 
  dphyl = phylo_distance_subset, weight = FALSE, Jost = FALSE, structure = NULL)

whole_area_div_summary <- data.frame(
  alpha_div = c(bird_div_all$TD$Mean_Alpha, bird_div_all$FD$Mean_Alpha, bird_div_all$PD$Mean_Alpha), 
  beta_add_div = c(bird_div_all$TD$Beta_add, bird_div_all$FD$Beta_add, bird_div_all$PD$Beta_add), 
  gamma_div = c(bird_div_all$TD$Gamma, bird_div_all$FD$Gamma, bird_div_all$PD$Gamma), 
  effective_units = c(bird_div_all$TD$Gamma / bird_div_all$TD$Mean_Alpha, bird_div_all$FD$Gamma / bird_div_all$FD$Mean_Alpha, bird_div_all$PD$Gamma / bird_div_all$PD$Mean_Alpha))
