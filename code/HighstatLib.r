...
corvif <- function(dataz) {
    ...
    tmp_cor_pearson <- cor(dataz, method = 'pearson', use="complete.obs")
    tmp_cor_spearman <- cor(dataz, method = 'spearman', use="complete.obs")
    print("Pearson's correlation coefficients")
    print(tmp_cor_pearson)
    print("Spearman's correlation coefficients")
    print(tmp_cor_spearman)
